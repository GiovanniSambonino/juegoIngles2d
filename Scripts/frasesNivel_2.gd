...
var gano = false
var ganoRonda = false
var palabrasEsp = BancoFrases.palabrasEspMedium 
var cadenas = BancoFrases.cadenasMedium 
var cadenasOrdenadas = BancoFrases.cadenasOrdenadasMedium 
...
func _process(_delta):
	if(instantiated):
		if ($Cadenas/Pieza0.correct and $Cadenas/Pieza1.correct and
			...
			$Cadenas/Pieza2.correct and $Cadenas/Pieza3.correct and numeroRondas < rondas and !ganoRonda and !gano):
			ganoRonda = true
			numeroRondas += 1
...
func _actualizar_velocidad():
	var tiempoFinal = 80#$Box_inside_game.time_seconds 
