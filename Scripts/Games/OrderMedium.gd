...
@export var palabra ="HOUSE"
@export var palabraES = "Casa"
...
func _ready():
	...
	emit_signal("uptate_imagen_game", "Casa")
...
func setLetters():
	...
	# Set shuffled letters for 5-letter word
	...
	# Set correct order for 5-letter word
